...
public class Archivo {
	...
	//si es rutaq recibe una ruta absoluta, entonces lo crea en esa ruta
	...
	public void lee_letra_x_letra() {
		...
		try {
			...
			int c= entrada.read(); // Lee rl primer caracter
				while (c!=-1)  // el read devuelve el codigo ASCHI, cuando no encuentra datos devuelve -1
				{
					char letra =(char) c;
